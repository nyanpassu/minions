...
binary:
	go build -ldflags "$(GO_LDFLAGS)" -a -tags netgo -installsuffix netgo -o $(BUILD_PATH)/eru-minions
# go build -ldflags "$(GO_LDFLAGS)" -a -tags netgo -installsuffix netgo -o $(BUILD_PATH)/minionsctl

debug-binary:
	go build -ldflags "$(GO_LDFLAGS)" -gcflags "-N -l" -a -tags netgo -installsuffix netgo -o $(BUILD_PATH)/eru-minions
# go build -ldflags "$(GO_LDFLAGS)" -gcflags "-N -l" -a -tags netgo -installsuffix netgo -o $(BUILD_PATH)/minionsctl 
